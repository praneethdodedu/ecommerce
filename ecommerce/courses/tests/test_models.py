...
from oscar.test.factories import PartnerFactory, create_order
...
class CourseTests(CourseCatalogTestMixin, TestCase):
    def test_unicode(self):
        ...
        course = Course.objects.create(id=course_id, site=self.site)
    ...
    def test_save_creates_parent_seat(self):
        ...
        course = Course.objects.create(id='a/b/c', name='Test Course', site=self.site)
        self.assertEqual(course.products.count(), 1)
    ...
    def test_collision_avoidance(self):
        ...
        """
        dotted_course = Course.objects.create(id='a/...course.../id', site=self.site)
        regular_course = Course.objects.create(id='a/course/id', site=self.site)
    ...
    def test_enrollment_code_seat_type_filter(self):
        ...
        toggle_switch(ENROLLMENT_CODE_SWITCH, True)
        course = Course.objects.create(id='test/course/123', name='Test Course 123', site=self.site)
