...
class ProductViewSetBase(ProductSerializerMixin, CourseCatalogTestMixin, TestCase):
    def setUp(self):
        ...
        self.course = Course.objects.create(id='edX/DemoX/Demo_Course', name='Test Course', site=self.site)
...
class ProductViewSetTests(ProductViewSetBase):
    ...
    def test_list_for_course(self):
        ...
        other_course = Course.objects.create(id='edX/DemoX/XYZ', name='Test Course 2', site=self.site)
